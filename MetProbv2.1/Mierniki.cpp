...
//******************************************************************************************
   float Mierniki::sredniah(int ile, float *czas)                     //srednia harmoniczna
     {
         suma=0;
         for (int i = 0 ; i < ile ; ++i)
             {
...
//******************************************************************************************
   float Mierniki::sredniag(int ile, float *czas)                     //srednia geometryczna
     {
        iloczyn=1;
        for (int i = 0 ; i < ile ; ++i)
            {
...
//******************************************************************************************
   float Mierniki::odchyleniestd(int ile, float *czas)                //odchylenie standardowe
     {
        return sqrt(wariancja(ile,czas));
     }
//******************************************************************************************
   float Mierniki::odchylenieodsr(int ile, float *czas)               //odchylenie od sredniej
     {
         sr=0;
         for (int i = 0 ; i < ile ; ++i)
...
//******************************************************************************************
   int Mierniki::maks(int ile, float *czas)                           //maksimum
     {
         int maks=czas[0];
         for(int i=1;i<ile;++i)
            if(maks<czas[i])
...
//******************************************************************************************
   int Mierniki::min(int ile, float *czas)                            //minimum
     {
         int min=czas[0];
         for(int i=1;i<ile;++i)
            if(min>czas[i])
